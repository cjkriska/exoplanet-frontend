function SystemModal({onClose, show, system}) {
    ...
    return (
        <div className="bg-dark-background w-[100%] h-[100%] z-0 top-0 absolute">
            ...
            <div className="flex flex-col w-3/4 h-3/4 bg-slate-200 text-black border-2 shadow-lg m-auto mt-20 z-10 text-gray-500">
                ...
                <div className="grid grid-cols-3 divide-x divide-slate-700 h-full p-7">
                    <div className="flex flex-col col-span-2 p-3">
                        ...
                        <div className="grow flex items-center basis-2/5">
                            <div className={(system.host.specType ? "bg-" + system.host.specType.charAt(0) : "bg-yellow-400") +" rounded-full w-40 h-40 m-5"} />
                            {system.planets.map((planet, index) => <div className="bg-gray-300 m-3 rounded-full w-10 h-10"/>)}
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col basis-2/3">
                            ...
                            <div className="basis-2/5">
                                <ul className="text-sm">
                                    ...
                                    <li>Spectral Type: {system.host.specType}</li>
                                    <li>Info: info</li>
